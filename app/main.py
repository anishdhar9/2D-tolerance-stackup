...
def main() -> None:
    ...
    st.caption("Draw/edit geometry, tweak selected feature, and get live simulation feedback.")
    ...
    should_auto_simulate = bool(features) and stopped_updating and signature != st.session_state.last_simulated_signature
